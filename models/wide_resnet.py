#WideResNet code is adopted from https://github.com/automl/trivialaugment/blob/b49e4da973b9247e1c20d9ed433a5d015ccd4cfb/TrivialAugment/networks/wideresnet.py
import torch
...
class WideResNet(nn.Module):
    def batchnorm_creator(self, c, momentum=_bn_momentum):
      return nn.BatchNorm2d(c, momentum=momentum)

    def __init__(self, depth, widen_factor, dropout_rate, num_classes, adaptive_dropouter_creator=None, adaptive_conv_dropouter_creator=None, 
    groupnorm=False, examplewise_bn=False, virtual_bn=False,):
        ...
        #self.norm_creator = self.batchnorm_creator(c, momentum=_bn_momentum)

        self.conv1 = conv3x3(3, nStages[0])
        self.layer1 = self._wide_layer(WideBasic, nStages[1], n, dropout_rate, stride=1)
        self.layer2 = self._wide_layer(WideBasic, nStages[2], n, dropout_rate, stride=2)
        self.layer3 = self._wide_layer(WideBasic, nStages[3], n, dropout_rate, stride=2)
        self.bn1 = self.batchnorm_creator(nStages[3], momentum=_bn_momentum)
    ...
    def _wide_layer(self, block, planes, num_blocks, dropout_rate, stride):
        ...
        for i,stride in enumerate(strides):
            ...
            new_block = block(self.in_planes, planes, dropout_rate, self.batchnorm_creator, stride, adaptive_dropouter_creator=ada_conv_drop_c)
    ...
    def forward(self, x):
        ...
        if len(self.adaptive_dropouters):
